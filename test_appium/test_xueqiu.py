...
class TestXueqiu:
    ...
    def test_webview(self):
        ...
        phone_selector = (By.CSS_SELECTOR, "[placeholder='请输入手机号']")
        WebDriverWait(self.driver, 20).until(expected_conditions.presence_of_element_located(phone_selector))
        self.driver.find_element(*phone_selector).send_keys("15711111111")
        self.driver.find_element(By.CSS_SELECTOR, '[placeholder="请输入验证码"]').send_keys('1223')
    ...
    def test_zuoye2(self):
        ...
        reslut = self.driver.find_element_by_xpath(
            '//*[@text="09988"]/../../..//*[@resource-id="com.xueqiu.android:id/current_price"]').text
        assert float(reslut) > 200
    ...
    def test_zuoye3(self):
        ...
        self.driver.find_element_by_xpath(
            '//*[@text="09988"]/../../..//*[@resource-id="com.xueqiu.android:id/add_attention"]').click()
        ...
        result = self.driver.find_element_by_xpath(
            '//*[@text="09988"]/../../..//*[contains(@resource-id, "add_attention")]/*').get_attribute('resource-id')
        assert 'followed_btn' in result
